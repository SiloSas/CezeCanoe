...
trait SmartCrop extends js.Object {
  var DEFAULTS =
}

trait SmartCropOptions extends js.Object {
  var width: Int = js.native
  var height:Int = js.native
  var aspect: Int = js.native
  var cropWidth: Int = js.native
  var cropHeight: Int = js.native
  var detailWeight: Double = js.native
  var skinColor: js.Array[Double] =  js.native
  var skinBias: Double = js.native
  var skinBrightnessMin: Double = js.native
  var skinBrightnessMax: Double = js.native
  var skinThreshold: Double = js.native
  var skinWeight: Double = js.native
  var saturationBrightnessMin: Double = js.native
  var saturationBrightnessMax: Double = js.native
  var saturationThreshold: Double = js.native
  var saturationBias: Double = js.native
  var saturationWeight: Double = js.native
  // step * minscale rounded down to the next power of two should be good
  var scoreDownSample: Double = js.native
  var step: Double = js.native
  var scaleStep: Double = js.native
  var minScale: Double = js.native
  var maxScale: Double = js.native
  var edgeRadius: Double = js.native
  var edgeWeight: Double = js.native
  var outsideImportance: Double = js.native
  var ruleOfThirds: Boolean = js.native
  var prescale: Boolean = js.native
  var canvasFactory: Option[String] = js.native
  var debug: Boolean = js.native
}


@injectable("smartCrop")
class SmartCropService() extends Service {

  @JSExport
  def SmartCrop(options) = {
